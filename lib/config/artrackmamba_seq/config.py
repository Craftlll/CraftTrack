...
"""
Add default config for ARTrackMambaSeq.
"""
cfg = edict()

# MODEL
cfg.MODEL = edict()
cfg.MODEL.NAME = "artrackmamba_seq"
...
cfg.MODEL.HEAD.NUM_CHANNELS = 192
cfg.MODEL.HEAD.VOCAB_SIZE = 4096

# MODEL.MEMORY
cfg.MODEL.MEMORY = edict()
cfg.MODEL.MEMORY.USE = True
cfg.MODEL.MEMORY.CAPACITY = 50
cfg.MODEL.MEMORY.UPDATE_INTERVAL = 5
cfg.MODEL.MEMORY.CONF_THRESHOLD = 0.7

# MODEL.EXTRA
cfg.MODEL.EXTRA = edict()
cfg.MODEL.EXTRA.SIGMA_FACTOR = 2.0
...
cfg.TRAIN.grad_clip_max_norm = 0.1
cfg.TRAIN.AMP = False
