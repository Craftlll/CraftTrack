...
def local_env_settings():
    ...
    settings.network_path = '/root/CraftTrack/output/test/networks'    # Where tracking networks are stored.
    settings.nfs_path = '/root/autodl-tmp/data/nfs'
    settings.otb_path = '/root/autodl-tmp/data/otb'
    settings.prj_dir = '/root/CraftTrack'
    settings.result_plot_path = '/root/CraftTrack/output/test/result_plots'
    settings.results_path = '/root/CraftTrack/output/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/root/CraftTrack/output'
    settings.segmentation_path = '/root/CraftTrack/output/test/segmentation_results'
